...
int main()
{
	...
	do{
		...
		printf("\n\n");
		printf("\t  ___________*_____*__****__*****_____ **___________________________________ \n");
		printf("\t / __________**___**__*____*__________*__*________________________________  |\n");
		printf("\t/ /          * * * *  **** *  ***    ******                               | |\n");
		printf("\t| |          *  *  *  *    *    **   *    *                               | |\n");
		printf("\t| |          *     *  ****  ******  *      *                              | |\n");
		printf("\t| | ***************************************************************       | |\n");
		...
		printf("\t| |                                    ***      *      * *   *   *  *     | |\n");
		printf("\t| |                                      ****   ****   *  *  *  ******    | |\n");
		printf("\t| |_______________________________________ ***__*______*_  *_*__*____*___/  |\n");
		printf("\t|______________________________________****** __*****__*____**_*______*____/ \n");
		printf(">>> ");
		scanf("%d",&Opcao);
